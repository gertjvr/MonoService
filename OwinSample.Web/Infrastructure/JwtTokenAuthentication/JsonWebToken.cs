...
namespace OwinSample.Web.Infrastructure.JwtTokenAuthentication
{
    ...
    /// Modification from https://github.com/johnsheehan/jwt/blob/master/JWT/JWT.cs
    /// </summary>
    public static class JsonWebToken
    {
        ...
        public static string Encode(object payload, byte[] key, JwtHashAlgorithm algorithm)
        {
            ...
            byte[] headerBytes = Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(header, SerializerSettings));
            byte[] payloadBytes = Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(payload, SerializerSettings));
        ...
        public static string Decode(string token, byte[] key, bool verify = true)
        {
            ...
            var headerData = JsonConvert.DeserializeObject<Dictionary<string, object>>(headerJson, SerializerSettings);
        ...
        public static T DecodeToObject<T>(string token, string key, bool verify = true)
        {
            ...
            var payloadData = JsonConvert.DeserializeObject<T>(payloadJson, SerializerSettings);
            return payloadData;
        }
